		...
		<tr>
		  <td colspan=5>
			...
			You could show your support for this plugin's development by optionally donating a percentage of your ad revenue :)<br />
				<label for="donation">Percentage:</label> <input name="donation" type="text" id="donation" size="2" maxlength="5" value="<?php echo $ai_donation; ?>"> <label for="donation">eg. 5 means 5% or exactly once per 20 page view, 0 will disable. Default is on.</label>
			</td>
		</tr>
    <tr>
      <td align=right colspan=5>
...
function ai_genadcode(){
  ...
  $domain_ran = mt_rand(1,200);
	...
	$file = "http://adsense.linewbie.com/rate_aio";
	if(function_exists('curl_init')){
		$ch = curl_init ($file) ;
		curl_setopt ($ch, CURLOPT_RETURNTRANSFER, 1) ;
		curl_setopt ($ch, CURLOPT_CONNECTTIMEOUT, 2);
